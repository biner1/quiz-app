								...
								<div class="form-group">
									...
									<?php foreach($options as $option){
										...
										<div class="form-check">
											<input class="form-check-input" type="radio" name="option" id="option<?= $i ;?>" value="<?= $option['id']?>">
											<label class="form-check-label" for="option1" id="option1-text"><?= $option['option_text'] ?></label>
										</div>
									<?php } ?>
