                            ...
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form class="mx-1 mx-md-4" id="signup-form">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-2">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input placeholder="Email" type="email" name="email" id="form3Example3c"
                                                class="form-control" />
                                                <small><label class="form-label" for="form3Example3c">Your Email</label></small> <br>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-2">
                                        ...
                                        <i class="fas fa-lock fa-lg fa-fw"></i>
                                        <div class="form-outline flex-fill mb-0">
                                            <input placeholder="confirm_password" type="password" name="confirm_password" id="confirm_password"
                                                class="form-control" />
                                           <small><label class="form-label" for="confirm_password">confirm password</label> </small><br>
                                        ...
                                        <input type="checkbox" name="is_teacher" value="1">
                                           <small><label for="is_teacher">Are you a teacher?</label></small><br>
