...
class UserController extends BaseController
{
    ...
    public function changePassword()
    {
        if (isset($_POST['change_password'])) {
            ...
            utils::responde(true, ['Success' => 'Password Change Success', 'redirect' => 'account']);
            exit();
        }
    }
        ...
        if (isset($_POST['update_picture']) && isset($_FILES['image'])) {
            ...
            if (User::updateUserImage($id, $newImageName)) {
                ...
                if (move_uploaded_file($image['tmp_name'], $newImagePath)) {
                    ...
                    utils::responde(true, ['Success' => 'Update Image Success', 'redirect' => 'account']);
                } else {
    ...
    public function update()
    {
        if (isset($_POST['update'])) {
            ...
            utils::responde(true, ['Success' => 'Update Account Success', 'redirect' => 'account']);
            exit;
        }
    }
