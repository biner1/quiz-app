...
class OptionController extends BaseController
{
    ...
    public function store()
    {
        if (isset($_POST['create_option'])) {
            ...
            if ($option) {
                ...
                utils::responde(true, ['Success' => 'Option Created', 'redirect' => 'quiz?id=' . $quiz_id]);
            } else {
    ...
    public function delete()
    {
        if (isset($_GET['id'])) {
            ...
            if ($option) {
                $quiz_id = $_GET['qid'];
                utils::responde(true, ['Success' => 'Option Deleted', 'redirect' => 'quiz?id=' . $quiz_id]);
            } else {
    ...
    public function update()
    {
        if (isset($_POST['update_option'])) {
            ...
            if ($option) {
                $quiz_id = $_POST['quiz_id'];
                utils::responde(true, ['Success' => 'Option Updated', 'redirect' => 'quiz?id=' . $quiz_id]);
            } else {
